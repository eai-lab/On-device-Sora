...
class Decoder(nn.Module):
    ...
    def __init__(
        ...
        # self.norm1 = GroupNorm(prev_filters, num_groups=self.num_groups)
        self.norm1 = nn.GroupNorm(self.num_groups, prev_filters)
