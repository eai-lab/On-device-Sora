...
class Decoder(nn.Module):
    ...
    def part2_3(self, x):
        ...
        if i > 0:
            ...
            x = x.unsqueeze(0)
        return x
    def part2_3_1(self, x):
        x = self.block_res_blocks[1][0](x)
        return x
    
    def part2_3_2(self, x):
        x = self.block_res_blocks[1][1](x)
        return x
    def part2_3_3(self, x):
        x = self.block_res_blocks[1][2](x)
        return x
    def part2_3_4(self, x):
        i = 1
        x = self.block_res_blocks[1][3](x)
        if i > 0:
            t_stride = 2 if self.temporal_downsample[i - 1] else 1
    ...
    def cforward(self,x):
        # it is roll-up version of forward
        x = self.conv1(x)
        residual = x
        # x = self.res_blocks[0].part1(x)
        # x = self.res_blocks[0].conv1(x)
        # x = self.res_blocks[0].part2(x)
        # x = self.res_blocks[0].conv2(x)
        # x = x + residual

        # residual = x
        # x = self.res_blocks[1].part1(x)
        # x = self.res_blocks[1].conv1(x)
        # x = self.res_blocks[1].part2(x)
        # x = self.res_blocks[1].conv2(x)
        # x = x + residual

        # residual = x
        # x = self.res_blocks[2].part1(x)
        # x = self.res_blocks[2].conv1(x)
        # x = self.res_blocks[2].part2(x)
        # x = self.res_blocks[2].conv2(x)
        # x = x + residual

        # residual = x
        # x = self.res_blocks[3].part1(x)
        # x = self.res_blocks[3].conv1(x)
        # x = self.res_blocks[3].part2(x)
        # x = self.res_blocks[3].conv2(x)
        # x = x + residual
        
        # # 3 0
        # residual = x
        # x = self.block_res_blocks[3][0].part1(x)
        # x = self.block_res_blocks[3][0].conv1(x)
        # x = self.block_res_blocks[3][0].part2(x)
        # x = self.block_res_blocks[3][0].conv2(x)
        # x = x + residual

        # # 3 1
        # residual = x
        # x = self.block_res_blocks[3][1].part1(x)
        # x = self.block_res_blocks[3][1].conv1(x)
        # x = self.block_res_blocks[3][1].part2(x)
        # x = self.block_res_blocks[3][1].conv2(x)
        # x = x + residual

        # # 3 2
        # residual = x
        # x = self.block_res_blocks[3][2].part1(x)
        # x = self.block_res_blocks[3][2].conv1(x)
        # x = self.block_res_blocks[3][2].part2(x)
        # x = self.block_res_blocks[3][2].conv2(x)
        # x = x + residual

        # # 3 3
        # residual = x
        # x = self.block_res_blocks[3][3].part1(x)
        # x = self.block_res_blocks[3][3].conv1(x)
        # x = self.block_res_blocks[3][3].part2(x)
        # x = self.block_res_blocks[3][3].conv2(x)
        # x = x + residual

        # t_stride = 2 if self.temporal_downsample[2] else 1
        ...
        # # 2 0
        # residual = x
        # x = self.block_res_blocks[2][0].part1(x)
        # x = self.block_res_blocks[2][0].conv1(x)
        # x = self.block_res_blocks[2][0].part2(x)
        # x = self.block_res_blocks[2][0].conv2(x)
        # residual = self.block_res_blocks[2][0].conv3(residual)
        # x = x + residual

        # # 2 1
        # residual = x
        # x = self.block_res_blocks[2][1].part1(x)
        # x = self.block_res_blocks[2][1].conv1(x)
        # x = self.block_res_blocks[2][1].part2(x)
        # x = self.block_res_blocks[2][1].conv2(x)
        # x = x + residual

        # # 2 2
        # residual = x
        # x = self.block_res_blocks[2][2].part1(x)
        # x = self.block_res_blocks[2][2].conv1(x)
        # x = self.block_res_blocks[2][2].part2(x)
        # x = self.block_res_blocks[2][2].conv2(x)
        # x = x + residual

        # # 2 3
        # residual = x
        # x = self.block_res_blocks[2][3].part1(x)
        # x = self.block_res_blocks[2][3].conv1(x)
        # x = self.block_res_blocks[2][3].part2(x)
        # x = self.block_res_blocks[2][3].conv2(x)
        # x = x + residual

        # t_stride = 2 if self.temporal_downsample[1] else 1
        ...
        # # 1 0
        # residual = x
        # x = self.block_res_blocks[1][0].part1(x)
        # x = self.block_res_blocks[1][0].conv1(x)
        # x = self.block_res_blocks[1][0].part2(x)
        # x = self.block_res_blocks[1][0].conv2(x)
        # x = x + residual

        # # 1 1
        # residual = x
        # x = self.block_res_blocks[1][1].part1(x)
        # x = self.block_res_blocks[1][1].conv1(x)
        # x = self.block_res_blocks[1][1].part2(x)
        # x = self.block_res_blocks[1][1].conv2(x)
        # x = x + residual

        # # 1 2
        # residual = x
        # x = self.block_res_blocks[1][2].part1(x)
        # x = self.block_res_blocks[1][2].conv1(x)
        # x = self.block_res_blocks[1][2].part2(x)
        # x = self.block_res_blocks[1][2].conv2(x)
        # x = x + residual

        # # 1 3
        # residual = x
        # x = self.block_res_blocks[1][3].part1(x)
        # x = self.block_res_blocks[1][3].conv1(x)
        # x = self.block_res_blocks[1][3].part2(x)
        # x = self.block_res_blocks[1][3].conv2(x)
        # x = x + residual
        
        # t_stride = 2 if self.temporal_downsample[0] else 1
        ...
        # # 0 0
        # residual = x
        # x = self.block_res_blocks[0][0].part1(x)
        # x = self.block_res_blocks[0][0].conv1(x)
        # x = self.block_res_blocks[0][0].part2(x)
        # x = self.block_res_blocks[0][0].conv2(x)
        # residual = self.block_res_blocks[0][0].conv3(residual)

        # x = x + residual
        # # 0 1
        # residual = x
        # x = self.block_res_blocks[0][1].part1(x)
        # x = self.block_res_blocks[0][1].conv1(x)
        # x = self.block_res_blocks[0][1].part2(x)
        # x = self.block_res_blocks[0][1].conv2(x)
        # x = x + residual
        # # 0 2
        # residual = x
        # x = self.block_res_blocks[0][2].part1(x)
        # x = self.block_res_blocks[0][2].conv1(x)
        # x = self.block_res_blocks[0][2].part2(x)
        # x = self.block_res_blocks[0][2].conv2(x)
        # x = x + residual
        # # 0 3
        # residual = x
        # x = self.block_res_blocks[0][3].part1(x)
        # x = self.block_res_blocks[0][3].conv1(x)
        # x = self.block_res_blocks[0][3].part2(x)
        # x = self.block_res_blocks[0][3].conv2(x)
        # x = x + residual
...
class VAE_Temporal(nn.Module):
    ...
    def part1(self, z):
        z = self.post_quant_conv(z)
        x = self.decoder.part1(z)
        return x
    
    def part2_1(self, z):
        x = self.decoder.part2_1(z)
        return x
    def part2_2(self, z):
        x = self.decoder.part2_2(z)
        return x
    def part2_3(self, z):
        x = self.decoder.part2_3(z)
        return x
    def part2_3_1(self, z):
        x = self.decoder.part2_3_1(z)
        return x
    def part2_3_2(self, z):
        x = self.decoder.part2_3_2(z)
        return x
    
    def part2_3_3(self, z):
        x = self.decoder.part2_3_3(z)
        return x
    def part2_3_4(self, z):
        x = self.decoder.part2_3_4(z)
        return x
    def part2_4(self, z):
        x = self.decoder.part2_4(z)
        return x
    
    
    def part3(self, z, num_frames=None):
        time_padding = (
            0
            if (num_frames % self.time_downsample_factor == 0)
            else self.time_downsample_factor - num_frames % self.time_downsample_factor
        )        
        x = self.decoder.part3(z)
        x = x[:, :, time_padding:]
